...
const AGENTS_S6_S10 = [
  {
    id: 'agente-portos',
    name: 'agente-portos',
    description: 'Manta 03-S7 — Especialista em projetos portuários e hidroviários.',
  ...
  },
  {
    ...
    description: 'Manta 03-S8 — Especialista em infraestrutura aeroportuária (lado ar + lado terra).',
  ...
  },
  {
    ...
    description: 'Manta 03-S9 — Especialista em saneamento básico (água, esgoto, drenagem urbana, resíduos). Prioridade AySA (Argentina).',
  ...
  },
  {
    ...
    description: 'Manta 03-S11 — Especialista em barragens (concreto, terra, enrocamento, rejeitos).',
