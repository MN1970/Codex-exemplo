...
Versão: **v5.4.7** (2026-09-13) — proposta de evolução do RAG (busca
...
11. [RAG — Evolução v5.4.7 (busca híbrida + versionamento)](#rag--evolução-v547-busca-híbrida--versionamento-proposta-não-aplicada)
12. [Deploy checklist v5.4.7 (RAG)](#deploy-checklist-v547-rag--busca-híbrida)
...
## RAG — Evolução v5.4.7: busca híbrida + versionamento (proposta, não aplicada)
...
## DEPLOY CHECKLIST v5.4.7 (RAG — busca híbrida)
...
- **v5.4.7** (2026-09-13) — proposta de evolução do RAG: busca híbrida
